...
import styles from "@/styles/landing-page/landingAnimation.module.css"
  ...
  return (
    <div className={styles.loadingPage}>
      ...
      <svg className={styles.logoSvg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
          className={styles.svgPath} /* Klasa do animacji */
      ...
      {/* Logo Name */}
      <div className={`${styles.logoText} ${styles.fadeInUp}`}>
        The chessboard is set, let the battle of wits begin
      </div>

      {/* Progress Bar */}
      <div className={styles.progressBar}>
      <div className={styles.progressBarInner} style={{ width: `${loadingProgress}%` }}></div>
      </div>
    </div>
  )
}
